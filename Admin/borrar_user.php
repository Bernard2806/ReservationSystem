    ...
    <nav class="navbar bg-body-tertiary" style="background:#635992;">
        <div class="container-fluid">
            <div class="d-flex align-items-center">
                ...
                <h1 class="navbar-text text-center font-italic mb-0" style="color: rgb(39, 23, 111); margin-left: 15px;">ELIMINAR USUARIO</h1>
            </div>
        </div>
    </nav>
    <br>
            ...
            <div class="col-6">
                ...
                <form action="baja_sql.php" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="nombreyapellido" name="nombreyapellido" readonly value="<?php echo $nombreapellido; ?>" class="form-control">
                    </div>

                    <div class="form-group">
                        <label for="password" class="font-weight-bold">Contraseña</label>
                        <input type="password" id="contraseña" name="contraseña" readonly value="********" class="form-control">
                    </div>

                    <?php if ($esAdmin) : ?>
                        <div class="form-group">
                            <div class="custom-control custom-switch">
                                <input type="checkbox" class="custom-control-input" id="esAdmin" name="esAdmin" checked disabled>
                    ...
                    <?php else : ?>
                        <div class="form-group">
                            <div class="custom-control custom-switch">
                                <input type="checkbox" class="custom-control-input" id="esAdmin" name="esAdmin" disabled>
                                <label class="font-weight-bold custom-control-label" for="esAdmin" style="color:white">Administrador</label>
                            </div>
                        </div>
                    <?php endif; ?>
                    ...
                    <button type="submit" class="btn btn-danger btn-block" name="boton" value=1>Eliminar usuario</button>
